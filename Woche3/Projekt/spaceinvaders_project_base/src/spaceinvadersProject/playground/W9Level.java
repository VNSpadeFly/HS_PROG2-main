 ...
 * </ul>
 */
public class W9Level extends Playground {
  ...
  //  public static final double SHOTSPEED = 600;
  ...
  //Aufgabe 4
  protected GameObject createEnemyShotObject(GameObject parentObject, String name,ObjectController ZickZackController) {
  ...
  protected GameObject createEnemyShot(GameObject e) {
    ...
    if (diceThrow < PROB) {
      ...
      GameObject textObject =
          createEnemyShotObject(e, "enmyShot" + nrEnemyShots, zickzackController);
  ...
  public void prepareLevel(String id) {
    ...
    GameObject borderObj4 = new RectObject("border4",this, CANVASX-400.,CANVASY-400,150,150,CANVASX,10, Color.BLUE).generateColliders();
    borderObj4.setController(new BounceController());
    addObject(borderObj4);

    GameObject borderObj5 = new RectObject("border4",this, CANVASX-500.,CANVASY-500,-150,-50,CANVASX,10, Color.GREEN).generateColliders() ;
    borderObj5.setController(new ControllerPreload());
    addObject(borderObj5);
